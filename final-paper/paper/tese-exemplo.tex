...
%-------------- highlights anything which is important using a greyish color background --%%
...
rightmargin=40,
backgroundcolor=gray!40]{myprop}
...
\input{softwareengineer/cap-engenhariasoftware}         % associado ao arquivo: 'cap-engenhariasoftware.tex'
