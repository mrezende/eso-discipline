...
\begin{center}
    \vspace*{2.3cm}
    \textbf{\Large{Estudo de caso: Resturante \textit{Da Gino}}}\\
...
\input{introduction/cap-introducao}        % associado ao arquivo: 'cap-introducao.tex'
\input{lifecyclemodel/cap-modeloprocesso}         % associado ao arquivo: 'cap-conceitos.tex'
\input{requirements/cap-requisitos}
\input{configurationmanagement/cap-configuracao-testes}
\input{management/cap-qualidade}
\input{conclusions/cap-conclusoes}        % associado ao arquivo: 'cap-conclusoes.tex'
...
\include{appendix/ape-conjuntos}      % associado ao arquivo: 'ape-conjuntos.tex'
